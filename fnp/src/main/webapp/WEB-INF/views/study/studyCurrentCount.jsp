						...
						<div class="row gtr-200">
								...
								<div id="sidebar1">
									...
									<!-- Sidebar 1 -->
										...
										<div class="sidemenu">
											...
											<form action="studyCount.do" method="post">
												<table>
													<tr>
							...
							<div class="col-8 col-12-narrower imp-narrower">
								...
								<div id="newStudy" class="topbox" style="margin-left: 5em; margin-bottom: 6em;">
									...
									<div class="tab" onclick="opentab('currentCount', this);" style="background-color: #37c0fb; color: white;">참여높은순</div>
									...
									<!-- 참여자 높은순 뷰 -->
									<div id="currentCount" class="tabcontent" style="display: block;">
										<table>
											<c:choose>
										...
										<div style="text-align: center">
											<c:url var="first" value="studyCount.do">
												<c:param name="page" value="1" />
											</c:url>
											<a href="${first }">[맨처음]</a>&nbsp;
											<c:url var="prev" value="studyCount.do">
												<c:param name="page" value="${startPage - limit }" />
											</c:url>
											<a href="${prev }">[이전]</a>&nbsp;
											<c:forEach var="p" begin="${startPage }" end="${endPage }" step="1">
												<c:url var="move" value="studyCount.do">
											...
											<c:url var="next" value="studyCount.do">
												<c:param name="page" value="${endPage - limit }" />
											</c:url>
											<a href="${next }">[next]</a>&nbsp;
											<c:url var="last" value="studyCount.do">
